...
public interface EliminarApi {
    ...
    @ApiOperation(value = "eliminar negocio", nickname = "eliminarDelete", notes = "", response = JsonApiBodyResponseSuccess.class, tags={ "negocio", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "negocio eliminada", response = JsonApiBodyResponseSuccess.class),
        @ApiResponse(code = 404, message = "datos imcompletos o incorrectos", response = JsonApiBodyResponseErrors.class) })
    @RequestMapping(value = "/eliminar",
        method = RequestMethod.POST)
    ResponseEntity<?> eliminarDelete(@ApiParam(value = "body" ,required=true )  @Valid @RequestBody JsonApiBodyRequestGet body);
